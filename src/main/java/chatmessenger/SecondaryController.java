...
// /*
//  * This part of the code allows the backend functionality to talk to the GUI in FXML for the CLIENT
//  */
...
//     //create a client reference variable
...
//         try{
//             //create a client object, server constructor takes a socket object
//             //socket listens for incoming connections, and when recieved one, creates a client object 
//             //used to communicate with whoever connected
//             //Socket represents client side and ServerSocket represents server side
